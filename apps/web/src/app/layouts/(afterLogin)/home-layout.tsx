...
export default function HomeLayout() {
  const [solvePopoverOpen, setSolvePopoverOpen] = useState(false);
  ...
  return (
    <aside className='bg-surface-var1 flex min-h-svh flex-col items-center justify-between border-[#A48C40] border-r-[0.5] pb-10 pt-5'>
      ...
      <div className='flex flex-col items-center gap-y-6'>
        ...
        <Popover open={solvePopoverOpen} onOpenChange={setSolvePopoverOpen}>
          <Popover.Trigger>
            <MenuBtnWrapper isPopupOpen={solvePopoverOpen}>
              <Image
                src={
          ...
          <Popover.Content align='center' side='right'>
            <div className='flex-center-col rounded-L shadow-modal-s w-full gap-y-2 border border-white/60 bg-white p-2'>
              <Link
                href='/step-up'
                className='rounded-L hover:bg-text-box w-[180] p-4'
                onClick={() => setSolvePopoverOpen(false)}
              >
