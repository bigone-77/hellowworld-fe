import StatItem from '@/components/(afterLogin)/step-up/components/stat-item';
import StepLabel from '@/components/(afterLogin)/step-up/components/step-label';

import { Mascot, Progressbar } from '@repo/ui/components';

export default function StepUpBanner() {
  return (
    <div className='bg-surface-var1 rounded-S relative w-full px-10 pb-10 pt-[18]'>
      <StepLabel
        step={2}
        title='왕초보 Python 입문'
        currentIdx={3}
        ...
        titleSize='l'
      />
      <div className='relative z-10 mt-[14] flex items-start justify-between'>
